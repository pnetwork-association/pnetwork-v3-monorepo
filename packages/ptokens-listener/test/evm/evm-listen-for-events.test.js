    ...
    it('Should call callback with the standardized event', async () => {
      ...
      try {
        ...
        if (_err.message === 'terminate') {
          expect(getDefaultProviderSpy).toHaveBeenNthCalledWith(
            1,
            'provider-url'
          )
          ...
          expect(callback).toHaveBeenNthCalledWith(1, {
            ...
            [schemas.constants.reportFields
              .SCHEMA_UNDERLYING_ASSET_DECIMALS_KEY]: null,
            [schemas.constants.reportFields
              .SCHEMA_UNDERLYING_ASSET_TOKEN_ADDRESS_KEY]: null,
            [schemas.constants.reportFields
              .SCHEMA_UNDERLYING_ASSET_NETWORK_ID_KEY]: null,
            ...
            [schemas.constants.reportFields.SCHEMA_ORIGINATING_BLOCK_HASH_KEY]:
              null,
            [schemas.constants.reportFields.SCHEMA_NETWORK_ID_KEY]:
              '0xe15503e4',
          ...
          expect(callback).toHaveBeenNthCalledWith(2, {
            ...
            [schemas.constants.reportFields
              .SCHEMA_UNDERLYING_ASSET_NETWORK_ID_KEY]: '0xe15503e4',
            [schemas.constants.reportFields
