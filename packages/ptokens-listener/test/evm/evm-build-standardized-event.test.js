...
describe('Event building for EVM', () => {
  describe('buildStandardizedEventFromEvmEvent', () => {
    ...
    it('Should build a standardized event object for a Redeem event', async () => {
      ...
      const eventName =
        'UserOperation(uint256 nonce,string destinationAccount,bytes4 destinationNetworkId,string underlyingAssetName,string underlyingAssetSymbol,address underlyingAssetTokenAddress,uint256 underlyingAssetChainId,address assetTokenAddress,uint256 assetAmount,bytes userData,bytes32 optionsMask)'
      ...
      const expected = {
        ...
        [schemas.constants.SCHEMA_NONCE_KEY]: '123456',
        [schemas.constants.SCHEMA_AMOUNT_KEY]: '1234567890',
        ...
        [schemas.constants.SCHEMA_UNDERLYING_ASSET_CHAIN_ID_KEY]: '0x01',
