...
const stringifyErrorsAndReject = _errors =>
  Promise.reject(stringifyErrors(_errors))

// Deprecated
const maybeExpandAggregatedErrorSync = _maybeErrors =>
  stringifyErrors(_maybeErrors)

// Deprecated
const maybeExpandAggregatedErrorAndReject = _maybeErrors =>
  stringifyErrorsAndReject(_maybeErrors)
