// taken here: https://github.com/maticnetwork/contracts/blob/main/test/helpers/merkle-tree.js
...
module.exports = class MerkleTree {
  constructor(leaves = []) {
    ...
    const l = leaves.concat(
      Array.from(Array(Math.pow(2, depth) - leaves.length), () => utils.zeros(32))
    )
