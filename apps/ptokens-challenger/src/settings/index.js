...
export default {
  ...
  lockAmountsStartChallenge: {
    [getNetworkIdByChain(mainnet)]: 100n,
    [getNetworkIdByChain(goerli)]: 100n,
    [getNetworkIdByChain(gnosis)]: 100n,
    [getNetworkIdByChain(polygon)]: 200n,
    [getNetworkIdByChain(arbitrum)]: 100n,
    [getNetworkIdByChain(bsc)]: 100n,
  },
  rpcUrls: {
  ...
  startChallengeThresholdBlocks: {
    ...
    [getNetworkIdByChain(polygon)]: 10,
    [getNetworkIdByChain(arbitrum)]: 600,
    [getNetworkIdByChain(bsc)]: 600,
  },
  startChallengeThresholdSeconds: {
    [getNetworkIdByChain(mainnet)]: 20 * 60,
    [getNetworkIdByChain(goerli)]: 20 * 60,
    [getNetworkIdByChain(gnosis)]: 20 * 60,
    [getNetworkIdByChain(polygon)]: 1,
    [getNetworkIdByChain(arbitrum)]: 20 * 60,
    [getNetworkIdByChain(bsc)]: 20 * 60,
  },
  monitorInactiveActorsTimeout: 10000, //10 * 60 * 1000,
  monitorInactiveActorsInterval: 30000, //3 * 60 * 1000,
  processPendingChallengesInterval: 15 * 60 * 1000,
}
